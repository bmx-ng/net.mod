...
ModuleInfo "Copyright: Wrapper - 2018-2026 Bruce A Henderson"

ModuleInfo "History: 1.09"
ModuleInfo "History: Moved some more source files to net.mbedtlscrypto."
...
'
' Patch notes :
'    For new releases, error.c and version_features.c are generated - can run 'make' to get one.
'
